...
final case class SalesRecord(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SalesRecord] {
    @transient
    ...
    def withDept(__v: _root_.scala.Predef.String): SalesRecord = copy(dept = __v)
    ...
    def companion: case_study_4.DynamicData.SalesRecord.SalesRecord.type = case_study_4.DynamicData.SalesRecord.SalesRecord
    // @@protoc_insertion_point(GeneratedMessage[case_study_4.DynamicData.SalesRecord])
}

object SalesRecord extends scalapb.GeneratedMessageCompanion[case_study_4.DynamicData.SalesRecord.SalesRecord] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[case_study_4.DynamicData.SalesRecord.SalesRecord] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): case_study_4.DynamicData.SalesRecord.SalesRecord = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[case_study_4.DynamicData.SalesRecord.SalesRecord] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = SalesRecordProto.javaDescriptor.getMessageTypes().get(0)
  ...
  lazy val defaultInstance = case_study_4.DynamicData.SalesRecord.SalesRecord(
    store = "",
    dept = "",
    date = "",
    weeklySales = 0.0f,
  ...
  implicit class SalesRecordLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, case_study_4.DynamicData.SalesRecord.SalesRecord]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, case_study_4.DynamicData.SalesRecord.SalesRecord](_l) {
  ...
  ): _root_.case_study_4.DynamicData.SalesRecord.SalesRecord = _root_.case_study_4.DynamicData.SalesRecord.SalesRecord(
    store,
    dept,
    date,
    weeklySales,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[case_study_4.DynamicData.SalesRecord])
}
